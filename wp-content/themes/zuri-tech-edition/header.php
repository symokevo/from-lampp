...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Title -->
        <title>Zuri - The Tech Edition.</title>
		
		<!-- Favicon -->
        <link rel="icon" href="<?php get_template_directory_uri(); ?>/assets/img/favicon.png">
		
		<!-- Google Fonts -->
		<link href="https://fonts.googleapis.com/css?family=Poppins:200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&display=swap" rel="stylesheet">

		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="<?php get_template_directory_uri(); ?>/assets/css/bootstrap.min.css">
		<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
		<!-- Nice Select CSS -->
		<link rel="stylesheet" href="<?php get_template_directory_uri(); ?>/assets/css/nice-select.css">
		<!-- Font Awesome CSS -->
