...
<section class="call-action overlay" data-stellar-background-ratio="0.9">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="content">
                    <h2 class="text-white">Do you need Emergency Medical Care? Call @ 1234 56789</h2>
                    <p class="call-to-action-p">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque porttitor dictum turpis nec gravida.</p>
                    <div class="button">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo get_template_directory_uri(); ?>/assets/img/section-img.png" alt="#">
                    <p>Lorem ipsum dolor sit amet consectetur adipiscing elit praesent aliquet. pretiumts</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-news">
                    <div class="news-head">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo get_template_directory_uri(); ?>/assets/img/blog1.jpg" alt="#">
                    </div>
                    <div class="news-body">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-news">
                    <div class="news-head">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo get_template_directory_uri(); ?>/assets/img/blog2.jpg" alt="#">
                    </div>
                    <div class="news-body">
                        <div class="news-content">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-news">
                    <div class="news-head">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo get_template_directory_uri(); ?>/assets/img/blog3.jpg" alt="#">
                    </div>
                    <div class="news-body">
                        <div class="news-content">
